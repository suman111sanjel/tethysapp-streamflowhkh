    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.streamflowhkh"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.streamflowhkh.tests.tests"

        To run tests in the StreamflowhkhTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.streamflowhkh.tests.tests.StreamflowhkhTestCase"

        To run only the test_if_tethys_platform_is_great function in the StreamflowhkhTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.streamflowhkh.tests.tests.StreamflowhkhTestCase.test_if_tethys_platform_is_great"
...
class StreamflowhkhTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Streamflowhkh)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Streamflowhkh)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/streamflowhkh/')  # The final '/' is essential for all pages/controllers
